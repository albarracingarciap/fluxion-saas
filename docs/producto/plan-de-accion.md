...
Cuatro cosas. Sin ellas, los pasos de abajo se quedan bloqueados.

**D1 · Regla de solapamiento de familias.** Un modo puede estar en dos familias
con valores distintos de O y D. *Recomendación: manda el más severo* — ante dos
estimaciones, en gestión de riesgos se toma la peor.

**D2 · Revisar el mapeo.** 15 subcategorías van marcadas con confianza media o
baja en `mapeo-subcategorias.csv`. Las demás las puedes dar por buenas.

**D3 · Confirmar el inventario de obligaciones.** Los 16 de prioridad alta de
`obligaciones-ai-act.csv`. Los 6 de prioridad baja —importadores,
distribuidores, representantes— probablemente no apliquen a tus clientes:
bórralos si estorban.

**D4 · ¿«Buena práctica» es una categoría propia?** Son 78 modos de generativa y
agéntica que van por delante de la norma. *Recomendación: sí* — se siguen
evaluando, pero no fingen una exigencia que no existe.

---

## Los pasos

### Paso 0 · Corregir el título del Art. 72

**Qué**: `AI-ACT-ART72` se titula «Evaluación de impacto de derechos
fundamentales (FRIA)». El 72 es vigilancia poscomercialización; la FRIA es el
27.

**Por qué**: es la única cosa de toda la lista que hoy **afirma algo falso sobre
la norma**.

**Coste**: un `UPDATE`. No depende de ninguna decisión.
...
|---|---|---|
| 0 · Corregir Art. 72 | — | Deja de mentir sobre la norma |
