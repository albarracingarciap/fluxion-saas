    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Medidas", href: "/datos/medidas" },
          { label: "Tipos de evidencia", href: "/datos/tipos-de-evidencia" },
          { label: "Obligaciones", href: "/datos/obligaciones" },
          { label: "Obligación ↔ Evidencia", href: "/datos/mappings/obligacion-evidencia" },
          { label: "Modo ↔ Medida", href: "/datos/mappings/modo-medida" },
          { label: "Relaciones Causales", href: "/datos/relaciones-causales" },
          { label: "Grafo Causal", href: "/datos/catalogo-causal" },
        ],
      },
    ],
  },
