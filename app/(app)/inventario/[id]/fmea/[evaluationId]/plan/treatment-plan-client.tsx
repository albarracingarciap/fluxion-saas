...
import { AlertTriangle, ArrowLeft, BarChart3, CheckCircle2, ChevronRight, ClipboardCheck, ListTodo, Loader2, Save, ShieldAlert, ThumbsDown, ThumbsUp, XCircle } from 'lucide-react';
...
function ApprovalReviewPanel({ data }: { data: TreatmentPlanData }) {
